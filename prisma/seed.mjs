...
const FANDOMS = [
  ...
  ["witcher",         "Ведьмак",         "GAME",    "Меч, серебро и тишина"],
  ["genshin",         "Genshin Impact",  "GAME",    "Мир, в который хочется вернуться"],
  ["naruto",          "Наруто",          "ANIME",   "Путь ниндзя"],
...
const PRODUCTS = [
  ...
  ["owl-mini",        "Полярная сова",          "harry-potter",    "PAINT_BY_NUMBERS",  80000, 1,  3, 12],
  ["ice-wall",        "Ледяная стена",          "game-of-thrones", "PAINT_BY_NUMBERS", 129000, 3, 12, 24],
  ["swamp-swordsman", "Мечник в тумане",        "witcher",         "DIAMOND_MOSAIC",   145000, 5, 26, 36],
  ["hero-city",       "Город героев",           "marvel",          "PAINT_BY_NUMBERS", 135000, 3, 14, 28],
  ["floating-isles",  "Парящие острова",        "genshin",         "DIAMOND_MOSAIC",   139000, 4, 20, 30],
  ["ninja-sunset",    "Закат над деревней",     "naruto",          "PAINT_BY_NUMBERS", 119000, 2,  8, 20],
  ["twin-suns",       "Два солнца",             "star-wars",       "DIAMOND_MOSAIC",   142000, 4, 19, 26],
  ["neon-alley",      "Неоновый переулок",      "cyberpunk",       "DIAMOND_MOSAIC",   148000, 5, 24, 34],
  ["hill-clouds",     "Холмы и облака",         "studio-ghibli",   "CROSS_STITCH",     125000, 3, 22, 18],
  ...
  for (const [slug, title, category, excerpt] of ARTICLES) {
    await prisma.article.upsert({
      ...
      create: { slug, title, category, excerpt, readMinutes: 5,
                publishedAt: new Date(), coverUrl: `/img/blog/${slug}.jpg`,
